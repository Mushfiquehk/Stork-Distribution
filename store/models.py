...
class Category(models.Model):
    ...
    image = models.ImageField(
        upload_to="category_images/", default="vendor_images/default.png")
...
class Product(models.Model):
    ...
    retail = models.DecimalField(
        max_digits=6, decimal_places=2, blank=True, default=99.99)
...
class Order(models.Model):
    ...
    phone_regex = RegexValidator(
        regex=r'^\+?1?\d{10,11}$', message="Phone number must be entered in the format: '1234567890'")
...
class Announcement(models.Model):
    ...
    image = models.ImageField(
        upload_to="announcements/", default="vendor_images/default.png")
